var ScrollOut = (function () {
  ...
  function P(e, t) {
    return e && 0 != e.length
      ? e.nodeName
        ? [e]
        : [].slice.call(e[0].nodeName ? e : (t || O).querySelectorAll(e))
      : [];
  }
    ...
    var o,
      ...
      X = function () {
        ...
        (i = {
          ...
          l &&
            ((l = !1),
            (c = P(v.targets || '[data-scroll]', P(v.scope || p)[0]).map(
              function (e) {
                return { $: e, ctx: {} };
              }
            ))),
          c.forEach(function (e) {
            ...
            e.ctx = {
              elementHeight: i,
              elementWidth: o,
              intersectX: 1 == c ? 0 : b(n - h),
              intersectY: 1 == l ? 0 : b(r - d),
              offsetX: n,
              offsetY: r,
              viewportX: s,
              viewportY: f,
              visibleX: c,
              visibleY: l,
              visible: +(v.offset ? v.offset <= d : (v.threshold || 0) < c * l),
            };
          });
      },
      Y =
        ((t = function () {
          if (c) {
            g(p, '_S', i) &&
              (x(p, { scrollDirX: i.scrollDirX, scrollDirY: i.scrollDirY }),
              a(p, i));
